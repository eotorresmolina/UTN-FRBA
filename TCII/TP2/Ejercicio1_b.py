...
"""
Ejercicio 1_b del TP2 de Teoría de los Circuitos II.
...
wp = 2*np.pi*fp     # Omega Desnormalizado
...
# Desnormalizo a Nivel de Frecuencia / Norma_Normalización = wp
NUM, DEN = sig.lp2lp ( NUM, DEN, wp )
